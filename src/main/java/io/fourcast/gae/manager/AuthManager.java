...
public class AuthManager {
    ...
    public static User validateUser(User user) throws OAuthRequestException {
        if (user == null) {
        ...
        if (SystemProperty.environment.value() == SystemProperty.Environment.Value.Development
            ...
            return new User(Globals.LOCAL_DEV_USER,"fourcast.io","114265751743224928536");
        }
    ...
    public static boolean validateUserAccess(User user, Globals.USER_ROLE role) throws UnauthorizedException{
        DSUser e2eUser = null;
        try {
